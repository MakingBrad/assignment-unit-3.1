...
// Brads favorite foods array
let bradNom = ['bacon','pad thai','gyros','carbohydrates', 'salad - NOT']

// Array.length: A property that tells you how many items are in a given array.
console.log('--- 2. Length of an array ---');
console.log ('Brad has this many favorite foods:' , bradNom.length)
...
let numberOfFoods = bradNom.length
...
console.log('The second animal in the animal array is:' , secondAnimal);
...
//Brad says, "I think I already did that above... unless I am not understanding the question"
...
let dessert = "Mom's apple pie"
bradNom.push(dessert);
console.log(bradNom)
...
let entree = "Spagetti and meatballs"
bradNom.unshift(entree)
console.log(bradNom)
...
console.log('The mistake addition to the array was:' , lastColor);
colors.pop()
console.log('The new array, without the mistake on it, is this:' , colors)
...
colors.shift()
console.log('The first color is:' , firstColor , "(It is stored in its own variable.)")
console.log('The new array, with the first color removed is:' , colors)
...
//I will pull index0 and index1 off (saving them to a separate array:staging) then remove
//them both from gems, and then "overwrite" Citrine with 'Tourmaline', and then
//write them back into gems using concatonate.  I'd bet there are 27 ways to do this
//this is the method I landed on.
let staging = []
//save 0 and 1 index to staging
staging.push(gems[0])
staging.push(gems [1])
//pop 'citrine' off staging and add 'Tourmaline'
staging.pop()
staging.push('Tourmaline')
//remove index 0 and 1 from gems with shift
gems.shift()
gems.shift()
//Concatonate the two arrays staging and gems to create the updated gems
gems = staging.concat(gems)
console.log ('The new gems array for 5.a is:' , gems)
//Staging still exists, and is holding copies of index0 and 1... no need to 
//"take out the trash" I don't think?
...
//I start by "sorting" it into alphabetical order
gems.sort();
console.log(gems)
//Then I create a gemStaging array to hold elements as I reverse them, and write
//the last index of gems to the 'top' of gemStaging and pop it off for the next
//I use a loop for this.  As of Aug 8 at 10am, I have not done this.
